...
### Fixed
- Advertise media duration and position for Home Assistant players that do not support seeking.
...
## v0.15.0 - 2026-01-13
### Added
- Select entity and input select support ([#83](https://github.com/unfoldedcircle/integration-home-assistant/pull/83)).

## v0.14.1 - 2025-12-02
### Fixed
- Voice assistant entity state updates and setting the correct "response_speech" attribute.
